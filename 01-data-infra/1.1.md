...
![AWS RDS vs Aurora (https://aws.amazon.com/ko/blogs/database/is-amazon-rds-for-postgresql-or-amazon-aurora-postgresql-a-better-choice-for-me/)](<../.gitbook/assets/image (4).png>)
...
![Redash Query Parameter (https://redash.io/help/user-guide/querying/query-parameters)](<../.gitbook/assets/image (5).png>)
...
한 가지 고민해보아야 할 점이 있습니다. AWS RDS / Aurora 를 S3 로 Snapshot 내보내는 AWS CLI API 를 살펴보면 어떤 인스턴스 내 DB / Table 를 뽑아낼지는 Column 결정할 수 없음. 컴퓨팅 사이즈도 결정할 수 없음
