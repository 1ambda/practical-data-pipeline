...
![Apache Kafka Cluster (Link)](<../../.gitbook/assets/image (36).png>)
...
![Kafka Topic (Link)](<../../.gitbook/assets/image (33).png>)

Kafka 에서 Producer 와 Consumer 는 데이터를 구분하기 위해 '**Topic**' 을 지정합니다. 다른 종류의 메세지는 다른 Topic 으로 보낼 수 있습니다.



![Kafka Topic Partition (Link)](<../../.gitbook/assets/image (19).png>)

![Kafka Topic Partition (Link)](<../../.gitbook/assets/image (18).png>)
...
![Kafka Multiple Partitions for a Single Topic (Link)](<../../.gitbook/assets/image (35).png>)
...
![Unbalanced Leaders (Link)](<../../.gitbook/assets/image (29).png>)

![Unbalanced Leaders (Link)](<../../.gitbook/assets/image (12).png>)

![Unbalanced Leaders (Link)](<../../.gitbook/assets/image (30).png>)
...
![Partition Offset and Consumer (Link)](<../../.gitbook/assets/image (10).png>)
...
![Kafka Overview 1 (Link)](<../../.gitbook/assets/image (34).png>)
