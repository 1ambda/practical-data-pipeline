...
![Partition Assignment Strategy: RoundRobin Assignment (Link)](<../../.gitbook/assets/image (29).png>)
...
![Kafka Consumer Rebalancing Before (Link)](<../../.gitbook/assets/image (22).png>)
...
![Group Coordinator Broker and Consumer Group Leader (Link)](<../../.gitbook/assets/image (30).png>)
...
![Incremental Rebalancing (Link)](<../../.gitbook/assets/image (27).png>)
...
![Kafka Consumer Offset Management (Link)](<../../.gitbook/assets/image (34).png>)
...
![Data Loss in Kafka Consumer (Link)](<../../.gitbook/assets/image (6).png>)
...
![Kafka Idempotent / Transaction (Link)](<../../.gitbook/assets/image (9).png>)
...
![Kafka Idempotent Producer 1 (Link)](<../../.gitbook/assets/image (7).png>)
...
![Kafka Transaction Explained (Link)](<../../.gitbook/assets/image (18).png>)
...
![Topic, Partition and Segment (Link)](<../../.gitbook/assets/image (23).png>)
...
![Kafka Segment Detail (Link)](<../../.gitbook/assets/image (21).png>)
...
\
\[HINT] 리텐션 기간 (log.retention.{ms,hours}) 는 어떤 값이 적정할까요?\
...
![Message Duplication by Producer (Link)](<../../.gitbook/assets/image (19).png>)

![Message Lost by Producer (Link)](<../../.gitbook/assets/image (33).png>)

![Message Re-processing by Consumer (Link)](<../../.gitbook/assets/image (8).png>)
