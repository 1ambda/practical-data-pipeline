...
![Columnar Format Overview (출처 표시)](<../../.gitbook/assets/image (6).png>)
...
![Vectorized Execution Overview (https://blog.cloudera.com/faster-swarms-of-data-accelerating-hive-queries-with-parquet-vectorization/)](<../../.gitbook/assets/image (7) (1) (1).png>)
...
![Parquet File Format Overview (http://peter-hoffmann.com/2020/understand-predicate-pushdown-on-rowgroup-level-in-parquet-with-pyarrow-and-python.html)](<../../.gitbook/assets/image (7) (1).png>)
