...
![Spark Supported File Formats and Storages (Link)](<../../.gitbook/assets/image (13) (1) (1) (1).png>)
...
![Columnar Format Overview (출처 표시)](<../../.gitbook/assets/image (6) (1) (1) (1) (1) (1) (1) (1).png>)
...
![Vectorized Execution Overview (https://blog.cloudera.com/faster-swarms-of-data-accelerating-hive-queries-with-parquet-vectorization/)](<../../.gitbook/assets/image (7) (1) (1) (1) (1) (1) (1) (1).png>)
...
![Parquet File Format Overview (http://peter-hoffmann.com/2020/understand-predicate-pushdown-on-rowgroup-level-in-parquet-with-pyarrow-and-python.html)](<../../.gitbook/assets/image (7) (1) (1) (1) (1) (1) (1).png>)
...
![Parquet Format Overview (https://dkharazi.github.io/blog/parquet)](<../../.gitbook/assets/image (8) (1) (1) (1) (1) (1) (1) (1).png>)
...
spark.sql.files.minPartitionNu
```
{% endhint %}
...
![Confluent Kafka Schema Registry Overview (https://docs.confluent.io/platform/current/schema-registry/index.html)](<../../.gitbook/assets/image (4) (1) (1) (1) (1).png>)
...
![Confluent Schema Registry (Link)](<../../.gitbook/assets/image (9).png>)
...
![Apache Hudi - Concept](<../../.gitbook/assets/image (33).png>)
...
1. airbnb\_listings 데이터와 airbnb\_reviews 데이터 를 합쳐 listing 별 리뷰 숫자와 평균 평점을 가진 DataFrame 을 만들고, airbnb\_stat\_review 테이블에 적재합니다. 평균 평점은 소수점 둘째자리까지만 남깁니다. (버림)
2. airbnb\_listings 데이터와 airbnb\_calendar 데이터를 합쳐 listing 별 예약 숫자와 예약 금액 합을 월별루 집계해 DataFrame 을 만들고 airbnb\_stat\_sales\_month 테이블에 적재합니다.
...
* Intellij (https://www.jetbrains.com/idea/) 내 Spark Gradle 프로젝트
  ...
  * 완료되면 로컬에서 spark-submit 등의 커맨드를 이용해 Spark Local Mode 로 Jar 를 실행해볼 수&#x20;
