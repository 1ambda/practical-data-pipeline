...
![Spark Cluster Mode Overview (https://spark.apache.org/docs/latest/cluster-overview.html) ](<../../.gitbook/assets/image (1) (1).png>)
...
![Spark Client Mode vs Cluster Mode Overview (출처 표기)](<../../.gitbook/assets/image (1) (1) (1) (1).png>)
