...
![Spark Cluster Mode Overview (https://spark.apache.org/docs/latest/cluster-overview.html)](<../../.gitbook/assets/image (2) (1) (1) (1) (1).png>)
...
![Spark Collect Overview (Link)](<../../.gitbook/assets/image (26).png>)
...
![Spark Executor Overview (Link)](<../../.gitbook/assets/image (14).png>)
...
![foreachRDD 1 (Spark Streaming Programming Techniques)](<../../.gitbook/assets/image (27).png>)

![foreachRDD 2 (Spark Streaming Programming Techniques)](<../../.gitbook/assets/image (32).png>)
...
![Spark Cluster Mode Overview (https://spark.apache.org/docs/latest/cluster-overview.html) ](<../../.gitbook/assets/image (1) (1) (1).png>)
...
![Spark Client Mode vs Cluster Mode Overview (출처 표기)](<../../.gitbook/assets/image (1) (1) (1) (1) (1).png>)
...
![Spark Yarn Cluster Mode (LInk)](<../../.gitbook/assets/image (8).png>)



![Flink Yarn Cluster Mode (LInk)](<../../.gitbook/assets/image (29).png>)



![AWS EMR Node Types (Link)](<../../.gitbook/assets/image (1).png>)
