...
![Spark Local Mode (Spark in Action)](<../../.gitbook/assets/image (12) (1).png>)

![Spark Client Mode (Spark in Action)](<../../.gitbook/assets/image (18) (1).png>)

![Spark Cluster Mode (Spark in Action)](<../../.gitbook/assets/image (3) (1).png>)
...
![](<../../.gitbook/assets/image (13) (1) (1).png>)![](<../../.gitbook/assets/image (3).png>)
...
![Spark < 1.6 Memory (Decoding Memory in Spark)](<../../.gitbook/assets/image (25).png>)

![Spark >= 1.6 Memory (Decoding Memory in Spark)](<../../.gitbook/assets/image (24).png>)
...
![Spark Memory Configuration Value (https://medium.com/analytics-vidhya/apache-spark-memory-management-49682ded3d42)](<../../.gitbook/assets/image (8) (1).png>)
...
![Non-JVM Spark Memory (Decoding Memory in Spark)](<../../.gitbook/assets/image (7).png>)
...
![ Spark Container Memory (Decoding Memory in Spark)](<../../.gitbook/assets/image (16) (1).png>)
...
![Spark Off-heap Usage (출처)](<../../.gitbook/assets/image (4).png>)
...
![PySpark Memory Configuration (Decoding Memory in Spark)](<../../.gitbook/assets/image (14).png>)
...
![On-prem Hadoop vs AWS EMR )https://aws.amazon.com/blogs/big-data/migrate-and-deploy-your-apache-hive-metastore-on-amazon-emr/\_](<../../.gitbook/assets/image (5).png>)
...
![EMR Node Types (EMR Best Practices)](<../../.gitbook/assets/image (23) (1) (1).png>)
...
![Spark on Kubernetes (https://aws.amazon.com/blogs/compute/running-cost-optimized-spark-workloads-on-kubernetes-using-ec2-spot-instances/)](<../../.gitbook/assets/image (21).png>)
...
![EMR on EMR vs EMR on EKS (AWS Blog)](<../../.gitbook/assets/image (20).png>)
...
![Spark Memory Management in Kubernetes (https://aws.amazon.com/blogs/containers/optimizing-spark-performance-on-kubernetes/)](<../../.gitbook/assets/image (6).png>)
...
![PySpark Data Flow (Apache Arrow with PySpark)](<../../.gitbook/assets/image (10) (1).png>)
...
![Apache Arrow](<../../.gitbook/assets/image (13) (1).png>)
...
![Python and JVM Processes Comm. (https://www.edureka.co/blog/spark-with-python-pyspark)](<../../.gitbook/assets/image (23) (1).png>)
...
![Python UDF w/ PySpark (https://dzone.com/articles/pyspark-java-udf-integration-1)](<../../.gitbook/assets/image (17) (1).png>)

![JVM UDF w/ PySpark (Python UDF w/ PySpark (https://dzone.com/articles/pyspark-java-udf-integration-1))](<../../.gitbook/assets/image (8).png>)
