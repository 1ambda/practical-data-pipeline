...
![Partition and Cache (https://www.nvidia.com/ko-kr/ai-data-science/spark-ebook/introduction-spark-processing/)](<../../.gitbook/assets/image (5).png>)
...
![Spark Memory Management (https://www.tutorialdocs.com/article/spark-memory-management.html)](<../../.gitbook/assets/image (12).png>)
