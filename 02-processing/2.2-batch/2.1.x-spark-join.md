...
![Spark Broadcast Join (Link)](<../../.gitbook/assets/image (27).png>)
...
![Broadcast Hash Join](<../../.gitbook/assets/image (32).png>)

![Spark Broadcast Hash Jo](<../../.gitbook/assets/image (35).png>)
...
Broadcast 될 대상 테이블이 클 경우 Driver 를 거쳐서 Broadcasting 이 발생하므로 Driver OOM 또는 Executor OOM 이 발생할 수 있습니다.&#x20;
...
![Shuffle Hash Join (Link)](<../../.gitbook/assets/image (19).png>)
